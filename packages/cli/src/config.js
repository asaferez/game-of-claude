...
export const API_BASE = process.env.GAME_OF_CLAUDE_API ?? "https://api.gameofclaude.online";
export const DASHBOARD_BASE = process.env.GAME_OF_CLAUDE_DASHBOARD ?? "https://gameofclaude.online";
